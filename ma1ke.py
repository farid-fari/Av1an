...
from commands import (
    ...
    Recount, NamedPipe, Tqdm, Rav1eEncodeFile)
import os
...
(default: randomly generated)')
    ...
    parser.add_argument(
        '-e', '--encoder', default='svt-av1', choices=[
            'svt-av1', 'rav1e', 'hevc'],
 ...
 (default: [input].csv)')
    ...
    if args.encoder == 'hevc':
        ...
        commandList.append(Rav1eEncodeFile())
    else:
    ...
    with open('Makefile', 'w') as fo:
        ...
        print(f'namedpipe = {os.path.join("$(tempdir)", "progressPipe")}\n',
              file=fo)
